 ...
 * As we're only working with a very small set of data and it's all about getting started quickly, I decided to do it the hardcoded way here.<br/>
 * Once the solution has made some progress on other ends, I'll go and make this more real-life usable.
